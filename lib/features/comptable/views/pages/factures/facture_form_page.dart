  ...
  void _saveInvoice() {
    if (_formKey.currentState!.validate()) {
      final invoice = InvoiceModel(
        ...
        totalTTC: _totalTTC,
        montantTVA:
            0, // Vous pouvez ajouter la logique de la TVA ici si nécessaire
        montantPaye:
            0, // Vous pouvez ajouter la logique de paiement ici si nécessaire
        status: widget.invoiceToEdit?.status ?? InvoiceModel.statusSubmitted,
        reference:
